...
session_register('ses_sql');
  ...
  // busqueda en clientes, mercaderia , facturalinea y factura    
  $sql="select c.num_cli, c.raz_cli,
                m.cod_mer, m.des_mer, m.uni_mer, m.cat_mer, m.iva_mer, m.stock_mer, m.peso_mer,
...
header('location:../../dominio/ventas/SeekPag_C.php');
?>